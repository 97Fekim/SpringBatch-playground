...
import com.psc.sample.q103.custom.CustomBeanWrapperFieldExtractor;
...
public class CsvJob2 {
    ...
    public FlatFileItemWriter<TwoDto> csvJob2_FileWriter(Resource resource) {
        ...
        CustomBeanWrapperFieldExtractor<TwoDto> customBeanWrapperFieldExtractor =
                new CustomBeanWrapperFieldExtractor<>();

        customBeanWrapperFieldExtractor.setNames(new String[]{"one", "two"});
        customBeanWrapperFieldExtractor.afterPropertiesSet();

        DelimitedLineAggregator<TwoDto> dtoDelimitedLineAggregator =
